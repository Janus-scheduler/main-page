...
function LandingPage() {
  ...
  return (
    <div style={{ width: '100%', maxWidth: '1440px', margin: '0 auto', background: 'var(--janus-bg)', color: 'var(--janus-text)' }}>
      ...
      {/* HERO */}
      <section style={{ padding: '88px 40px 0', display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' }}>
        ...
        <h1 style={{ margin: '22px 0 0', maxWidth: '19ch', font: '700 68px/1.03 "DM Sans", sans-serif', letterSpacing: '-0.032em', textWrap: 'balance' }}>
          Natural-language scheduling for any web app.
        </h1>
        <p style={{ margin: '24px 0 0', maxWidth: '74ch', font: '400 17.5px/1.6 "DM Sans", sans-serif', color: 'var(--janus-text-secondary)', textWrap: 'pretty' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginTop: '22px', padding: '11px 14px', border: '1.5px solid var(--janus-border)', borderRadius: '9px', background: 'var(--janus-surface)' }}>
          <span style={{ font: '400 13.5px/1 "JetBrains Mono", monospace', color: 'var(--janus-accent)' }}>$</span>
          <span style={{ font: '400 13.5px/1 "JetBrains Mono", monospace', color: 'var(--janus-text)' }}>npm i @janus-scheduler/react</span>
          <button onClick={handleCopyInstall} style={{ height: '26px', padding: '0 9px', border: '1.5px solid var(--janus-border)', borderRadius: '9px', background: 'var(--janus-bg)', color: 'var(--janus-text-secondary)', font: '500 11px/1 "JetBrains Mono", monospace', cursor: 'pointer' }}>
      ...
      <section style={{ padding: '56px 40px 0' }}>
        <div style={{ border: '1.5px solid var(--janus-border)', borderRadius: '14px', background: 'var(--janus-surface)', padding: '20px', boxShadow: 'var(--janus-shadow)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '10px 12px 10px 16px', border: '1.5px solid var(--janus-border)', borderRadius: '9px', background: 'var(--janus-bg)', boxShadow: 'var(--janus-shadow)' }}>
            <span style={{ font: '400 15px/1 "JetBrains Mono", monospace', color: 'var(--janus-accent)' }}>✦</span>
            <input type="text" placeholder="Try 'Schedule a design sync with Alex tomorrow at 10am in Room A'" style={{ flex: 1, height: '32px', border: 0, background: 'transparent', outline: 'none', font: '400 14.5px/1 "DM Sans", sans-serif', color: 'var(--janus-text)' }} />
            <span style={{ font: '400 11px/1 "JetBrains Mono", monospace', color: 'var(--janus-text-muted)' }}>parsed locally</span>
            <button className="janus-btn janus-btn-primary" style={{ height: '34px' }}>Schedule</button>
          </div>
          ...
          <div style={{ marginTop: '16px', border: '1.5px solid var(--janus-border)', borderRadius: '14px', background: 'var(--janus-bg)', overflow: 'hidden' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '12px 16px', borderBottom: '1px solid var(--janus-border)' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
                <span style={{ font: '600 14px/1 "DM Sans", sans-serif' }}>Thursday, 3 September</span>
                <div style={{ display: 'inline-flex', padding: '3px', gap: '2px', background: 'var(--janus-surface)', border: '1.5px solid var(--janus-border)', borderRadius: '9px' }}>
                  <span style={{ padding: '5px 11px', borderRadius: '6px', background: 'var(--janus-bg)', color: 'var(--janus-text)', font: '600 12px/1 "DM Sans", sans-serif', boxShadow: 'var(--janus-shadow-sm)' }}>Timeline</span>
                  <span style={{ padding: '5px 11px', borderRadius: '6px', color: 'var(--janus-text-secondary)', font: '500 12px/1 "DM Sans", sans-serif' }}>Week</span>
                  <span style={{ padding: '5px 11px', borderRadius: '6px', color: 'var(--janus-text-secondary)', font: '500 12px/1 "DM Sans", sans-serif' }}>Month</span>
                </div>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                <span style={{ font: '400 11.5px/1 "JetBrains Mono", monospace', color: 'var(--janus-text-muted)' }}>Europe/Colombo · UTC+5:30</span>
                <div style={{ display: 'inline-flex', alignItems: 'center', border: '1.5px solid var(--janus-border)', borderRadius: '9px', overflow: 'hidden' }}>
                  <span style={{ padding: '5px 10px', font: '500 12px/1 "JetBrains Mono", monospace', color: 'var(--janus-text-secondary)', cursor: 'pointer' }}>−</span>
                  <span style={{ padding: '5px 10px', borderLeft: '1.5px solid var(--janus-border)', borderRight: '1.5px solid var(--janus-border)', font: '500 11.5px/1 "JetBrains Mono", monospace', color: 'var(--janus-text-secondary)' }}>1 h</span>
                  <span style={{ padding: '5px 10px', font: '500 12px/1 "JetBrains Mono", monospace', color: 'var(--janus-text-secondary)', cursor: 'pointer' }}>+</span>
                </div>
              </div>
            </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '212px 1fr' }}>
              <div style={{ borderRight: '1.5px solid var(--janus-border)' }}>
                <div style={{ height: '34px', display: 'flex', alignItems: 'center', padding: '0 16px', borderBottom: '1px solid var(--janus-border)', background: 'var(--janus-surface)', font: '500 10.5px/1 "JetBrains Mono", monospace', letterSpacing: '0.08em', textTransform: 'uppercase', color: 'var(--janus-text-muted)' }}>Resources</div>
                <div style={{ height: '52px', display: 'flex', alignItems: 'center', gap: '10px', padding: '0 16px', borderBottom: '1px solid var(--janus-border)' }}>
                  <span style={{ width: '24px', height: '24px', borderRadius: '999px', background: 'var(--janus-surface)', border: '1px solid var(--janus-border)', display: 'flex', alignItems: 'center', justifyContent: 'center', font: '600 10px/1 "JetBrains Mono", monospace', color: 'var(--janus-text-secondary)' }}>AF</span>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '2px' }}><span style={{ font: '500 13px/1.2 "DM Sans", sans-serif' }}>Alex Fernando</span><span style={{ font: '400 10.5px/1 "JetBrains Mono", monospace', color: 'var(--janus-text-muted)' }}>Design</span></div>
                </div>
                <div style={{ height: '52px', display: 'flex', alignItems: 'center', gap: '10px', padding: '0 16px', borderBottom: '1px solid var(--janus-border)' }}>
                ...
                <div style={{ height: '52px', display: 'flex', alignItems: 'center', gap: '10px', padding: '0 16px', borderBottom: '1px solid var(--janus-border)' }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '2px' }}><span style={{ font: '500 13px/1.2 "DM Sans", sans-serif' }}>Chamath Silva</span><span style={{ font: '400 10.5px/1 "JetBrains Mono", monospace', color: 'var(--janus-text-muted)' }}>Engineering</span></div>
                </div>
                <div style={{ height: '52px', display: 'flex', alignItems: 'center', gap: '10px', padding: '0 16px', borderBottom: '1px solid var(--janus-border)' }}>
                  <span style={{ width: '24px', height: '24px', borderRadius: '6px', background: 'var(--janus-surface)', border: '1.5px solid var(--janus-border)', display: 'flex', alignItems: 'center', justifyContent: 'center', font: '600 10px/1 "JetBrains Mono", monospace', color: 'var(--janus-text-secondary)' }}>A</span>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '2px' }}><span style={{ font: '500 13px/1.2 "DM Sans", sans-serif' }}>Room A</span><span style={{ font: '400 10.5px/1 "JetBrains Mono", monospace', color: 'var(--janus-text-muted)' }}>Seats 8 · display</span></div>
                </div>
                <div style={{ height: '52px', display: 'flex', alignItems: 'center', gap: '10px', padding: '0 16px' }}>
                  <span style={{ width: '24px', height: '24px', borderRadius: '6px', background: 'var(--janus-surface)', border: '1.5px solid var(--janus-border)', display: 'flex', alignItems: 'center', justifyContent: 'center', font: '600 10px/1 "JetBrains Mono", monospace', color: 'var(--janus-text-secondary)' }}>B</span>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '2px' }}><span style={{ font: '500 13px/1.2 "DM Sans", sans-serif' }}>Room B</span><span style={{ font: '400 10.5px/1 "JetBrains Mono", monospace', color: 'var(--janus-text-muted)' }}>Seats 20 · video</span></div>
                </div>
              </div>

              <div className="jscroll" style={{ position: 'relative' }}>
                <div style={{ height: '34px', display: 'grid', gridTemplateColumns: 'repeat(10, 1fr)', borderBottom: '1px solid var(--janus-border)', background: 'var(--janus-surface)' }}>
      ...
      <section style={{ padding: '36px 40px 0' }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '34px', padding: '18px 24px', borderTop: '1px solid var(--janus-border)', borderBottom: '1px solid var(--janus-border)' }}>
      ...
      {/* PROBLEM */}
      <section style={{ padding: '96px 40px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '14px', textAlign: 'center' }}>
        ...
        <p style={{ margin: '8px 0 0', font: '600 30px/1.35 "DM Sans", sans-serif', letterSpacing: '-0.02em', maxWidth: '28ch' }}>Every scheduler is locked to one framework.</p>
        <p style={{ margin: '0', font: '600 30px/1.35 "DM Sans", sans-serif', letterSpacing: '-0.02em', color: 'var(--janus-text-muted)', maxWidth: '34ch' }}>The good ones are commercially licensed.</p>
        <p style={{ margin: '0', font: '600 30px/1.35 "DM Sans", sans-serif', letterSpacing: '-0.02em', color: 'var(--janus-text-muted)', maxWidth: '34ch' }}>And almost all of them need a backend.</p>
      </section>

      {/* FEATURES GRID */}
      <section id="features" style={{ padding: '0 40px' }}>
        <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', marginBottom: '26px', flexWrap: 'wrap', gap: '16px' }}>
          <h2 style={{ margin: 0, font: '700 34px/1.15 "DM Sans", sans-serif', letterSpacing: '-0.025em' }}>Everything a scheduler owes you</h2>
          <Link to="/features" style={{ font: '600 13.5px/1 "JetBrains Mono", monospace', color: 'var(--janus-accent-text)' }}>All features →</Link>
        </div>
      ...
      <section style={{ padding: '104px 40px 0' }}>
        <div className="grid-report" style={{ display: 'grid', gap: '56px', alignItems: 'center' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            ...
            <h2 style={{ margin: 0, font: '700 42px/1.1 "DM Sans", sans-serif', letterSpacing: '-0.028em', maxWidth: '16ch' }}>Type it, don't build it</h2>
          ...
          <div style={{ border: '1.5px solid var(--janus-border)', borderRadius: '14px', background: 'var(--janus-surface)', padding: '28px', boxShadow: 'var(--janus-shadow)', display: 'flex', flexDirection: 'column', gap: '22px' }}>
            <div style={{ padding: '18px 20px', border: '1.5px solid var(--janus-border)', borderRadius: '9px', background: 'var(--janus-bg)', font: '400 18px/1.9 "DM Sans", sans-serif' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '9px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '9px', padding: '9px 11px', borderRadius: '9px', background: 'var(--janus-bg)', border: '1.5px solid rgba(13,148,136,0.62)' }}>
                <span style={{ font: '500 10px/1 "JetBrains Mono", monospace', letterSpacing: '0.08em', textTransform: 'uppercase', color: '#14b8a6' }}>date</span>
                <span style={{ font: '500 12.5px/1 "JetBrains Mono", monospace' }}>2026-08-30</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '9px', padding: '9px 11px', borderRadius: '9px', background: 'var(--janus-bg)', border: '1.5px solid rgba(249,115,22,0.66)' }}>
                ...
                <span style={{ font: '500 12.5px/1 "JetBrains Mono", monospace' }}>10:00 – 11:00</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '9px', padding: '9px 11px', borderRadius: '9px', background: 'var(--janus-bg)', border: '1.5px solid rgba(37,99,235,0.62)' }}>
                ...
                <span style={{ font: '500 12.5px/1 "JetBrains Mono", monospace' }}>alex.f</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '9px', padding: '9px 11px', borderRadius: '9px', background: 'var(--janus-bg)', border: '1.5px solid rgba(124,58,237,0.5)' }}>
                ...
                <span style={{ font: '500 12.5px/1 "JetBrains Mono", monospace' }}>room-a</span>
              </div>
            </div>

            <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
              <span style={{ flex: 1, height: '1.5px', background: 'var(--janus-border)' }} />
              <span style={{ font: '400 13px/1 "JetBrains Mono", monospace', color: 'var(--janus-text-muted)' }}>↓ committed</span>
              <span style={{ flex: 1, height: '1.5px', background: 'var(--janus-border)' }} />
            </div>

            <div style={{ borderRadius: '9px', background: 'var(--janus-accent-tint)', border: '1.5px solid var(--janus-accent)', padding: '12px 14px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '3px' }}>
                <span style={{ font: '600 14px/1.2 "DM Sans", sans-serif', color: 'var(--janus-accent-text-dark)' }}>Design sync · Alex Fernando</span>
                <span style={{ font: '400 11.5px/1 "JetBrains Mono", monospace', color: 'var(--janus-accent-text)' }}>Sun 30 Aug · 10:00 – 11:00 · Room A</span>
              </div>
      ...
      <section style={{ padding: '104px 40px 0' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1.15fr 1fr', gap: '56px', alignItems: 'center' }}>
          <div style={{ border: '1.5px solid var(--janus-border)', borderRadius: '14px', background: 'var(--janus-surface)', padding: '34px 28px', boxShadow: 'var(--janus-shadow)' }}>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 132px 1fr', alignItems: 'center', gap: '0' }}>
              <div style={{ border: '1.5px solid var(--janus-border)', borderRadius: '14px', background: 'var(--janus-bg)', padding: '18px', display: 'flex', flexDirection: 'column', gap: '12px' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                  <span style={{ width: '16px', height: '16px', borderRadius: '5px', background: 'var(--janus-accent)' }}></span>
                  <span style={{ font: '600 13px/1 "DM Sans", sans-serif', color: 'var(--janus-text)' }}>Janus calendar</span>
                </div>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                  <span style={{ height: '22px', borderRadius: '6px', background: 'var(--janus-accent-tint)', border: '1.5px solid var(--janus-accent)' }}></span>
                  <span style={{ height: '22px', borderRadius: '6px', background: 'rgba(59,130,246,0.15)', border: '1.5px solid rgba(59,130,246,0.6)' }}></span>
                  <span style={{ height: '22px', borderRadius: '6px', background: 'var(--janus-surface)', border: '1.5px solid var(--janus-border)' }}></span>
                </div>
                <span style={{ font: '400 10.5px/1.4 "JetBrains Mono", monospace', color: 'var(--janus-text-muted)' }}>local state · source of truth</span>
              </div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '10px', padding: '0 12px' }}>
                <div style={{ width: '100%', display: 'flex', alignItems: 'center', gap: '6px' }}>
                  <span style={{ flex: '1', height: '1.5px', background: 'var(--janus-accent)' }}></span>
                  <span style={{ font: '400 12px/1 "JetBrains Mono", monospace', color: 'var(--janus-accent)' }}>▶</span>
                </div>
                <span style={{ padding: '4px 9px', borderRadius: '999px', background: 'var(--janus-bg)', border: '1.5px solid var(--janus-border)', font: '500 10.5px/1.3 "JetBrains Mono", monospace', color: 'var(--janus-text-secondary)' }}>two-way sync</span>
                <div style={{ width: '100%', display: 'flex', alignItems: 'center', gap: '6px' }}>
                  <span style={{ font: '400 12px/1 "JetBrains Mono", monospace', color: 'var(--janus-text-muted)' }}>◀</span>
                  <span style={{ flex: '1', height: '1.5px', background: 'var(--janus-border)' }}></span>
                </div>
                <span style={{ font: '400 10px/1.4 "JetBrains Mono", monospace', color: 'var(--janus-text-muted)', textAlign: 'center' }}>incremental<br />syncToken</span>
              </div>

              <div style={{ border: '1.5px solid var(--janus-border)', borderRadius: '14px', background: 'var(--janus-bg)', padding: '18px', display: 'flex', flexDirection: 'column', gap: '12px' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                  <span style={{ width: '16px', height: '16px', borderRadius: '5px', background: 'var(--janus-surface)', border: '1.5px solid var(--janus-border)' }}></span>
                  <span style={{ font: '600 13px/1 "DM Sans", sans-serif', color: 'var(--janus-text)' }}>Google Calendar</span>
                </div>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                  <span style={{ height: '22px', borderRadius: '6px', background: 'var(--janus-surface)', border: '1.5px solid var(--janus-border)' }}></span>
                  <span style={{ height: '22px', borderRadius: '6px', background: 'var(--janus-surface)', border: '1.5px solid var(--janus-border)' }}></span>
                ...
                <span style={{ font: '400 10.5px/1.4 "JetBrains Mono", monospace', color: 'var(--janus-text-muted)' }}>OAuth 2.0 · events.watch</span>
              </div>
            </div>
            <div style={{ marginTop: '22px', paddingTop: '16px', borderTop: '1px solid var(--janus-border)', display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', gap: '10px' }}>
              <span style={{ font: '400 11.5px/1 "JetBrains Mono", monospace', color: 'var(--janus-text-muted)' }}>conflict policy: last-write-wins, per field</span>
              <span style={{ font: '400 11.5px/1 "JetBrains Mono", monospace', color: 'var(--janus-text-muted)' }}>delta poll: 30 s</span>
            </div>
          </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            ...
            <h2 style={{ margin: '0', font: '700 42px/1.1 "DM Sans", sans-serif', letterSpacing: '-0.028em', maxWidth: '17ch', color: 'var(--janus-text)' }}>One calendar, two directions</h2>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', padding: '16px 18px', border: '1.5px solid var(--janus-border)', borderRadius: '14px', background: 'var(--janus-surface)' }}>
              ...
              <p style={{ margin: '0', font: '400 13.5px/1.6 "DM Sans", sans-serif', color: 'var(--janus-text-secondary)' }}>The sync adapter needs a token endpoint of your own — Janus never holds a client secret in the browser.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: '128px 40px 0' }}>
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '16px', textAlign: 'center', marginBottom: '44px' }}>
          ...
          <h2 style={{ margin: '0', font: '700 48px/1.08 "DM Sans", sans-serif', letterSpacing: '-0.03em', maxWidth: '24ch', color: 'var(--janus-text)' }}>The same component, in the framework you already use</h2>
          <p style={{ margin: '0', maxWidth: '62ch', font: '400 17px/1.6 "DM Sans", sans-serif', color: 'var(--janus-text-secondary)', textWrap: 'pretty' }}>One Lit core, thin wrappers. Props, events and theming are identical everywhere — the wrappers exist only to make the ergonomics native.</p>
        </div>

        <div style={{ border: '1.5px solid var(--janus-border)', borderRadius: '14px', overflow: 'hidden', boxShadow: 'var(--janus-shadow)' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 16px', background: 'var(--janus-surface)', borderBottom: '1.5px solid var(--janus-border)' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <span style={{ font: '400 11.5px/1 "JetBrains Mono", monospace', color: 'var(--janus-text-muted)' }}>{currentTab?.pkg}</span>
          ...
          <div style={{ background: '#18181b', minHeight: '392px', display: 'flex' }}>
            <div style={{ width: '60px', flex: 'none', padding: '26px 0', borderRight: '1px solid #27272a', display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: '0', font: '400 13px/1.85 "JetBrains Mono", monospace', color: '#52525b' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '14px 18px', borderTop: '1.5px solid var(--janus-border)', background: 'var(--janus-surface)' }}>
      ...
      <section style={{ padding: '112px 40px 0' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1.05fr 1fr', gap: '48px', alignItems: 'center' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            ...
            <h2 style={{ margin: '0', font: '700 42px/1.1 "DM Sans", sans-serif', letterSpacing: '-0.028em', maxWidth: '18ch', color: 'var(--janus-text)' }}>Twelve custom properties, no build step</h2>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
              ...
              <div style={{ display: 'flex', gap: '9px', alignItems: 'center' }}>
                <span style={{ width: '34px', height: '34px', borderRadius: '9px', background: '#f97316', boxShadow: '0 0 0 3px rgba(249,115,22,0.22)', cursor: 'pointer' }}></span>
                ...
                <span style={{ width: '34px', height: '34px', borderRadius: '9px', background: 'var(--janus-text)', border: '1px solid var(--janus-border)', cursor: 'pointer' }}></span>
                <span style={{ width: '1px', height: '26px', background: 'var(--janus-border)', margin: '0 4px' }}></span>
                <div onClick={() => setThemeDark(!themeDark)} style={{ display: 'inline-flex', padding: '3px', gap: '2px', background: 'var(--janus-surface)', border: '1.5px solid var(--janus-border)', borderRadius: '9px', cursor: 'pointer' }}>
                  <span style={{ padding: '6px 12px', borderRadius: '6px', background: `${sunBg.trim()}`, color: `${sunFg.trim()}`, font: '600 11.5px/1 "DM Sans", sans-serif', boxShadow: !dark ? 'var(--janus-shadow-sm)' : 'none' }}>Light</span>
                  <span style={{ padding: '6px 12px', borderRadius: '6px', background: `${moonBg.trim()}`, color: `${moonFg.trim()}`, font: '600 11.5px/1 "DM Sans", sans-serif', boxShadow: dark ? 'var(--janus-shadow-sm)' : 'none' }}>Dark</span>
                </div>
              </div>
      ...
      {/* ── PERFORMANCE ─────────────────────────── */}
      <section style={{ padding: '112px 40px 0' }}>
        <div style={{ background: '#09090b', border: '1px solid #27272a', borderRadius: '14px', padding: '56px 48px', display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: '32px' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', paddingLeft: '32px', borderLeft: '1px solid #27272a' }}>
            <span style={{ font: '700 60px/1 "DM Sans",sans-serif', letterSpacing: '-0.035em', color: '#fafafa' }}>63k+<span style={{ fontSize: '26px', color: '#f97316' }}> events</span></span>
      ...
      <section style={{ padding: '112px 40px 0' }}>
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '14px', textAlign: 'center', marginBottom: '40px' }}>
          ...
          <h2 style={{ margin: '0', font: '700 34px/1.15 "DM Sans", sans-serif', letterSpacing: '-0.025em', color: 'var(--janus-text)' }}>Three packages, one direction of dependency</h2>
        </div>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 64px 1fr 64px 1fr', alignItems: 'stretch' }}>
          <div style={{ border: '1.5px solid var(--janus-border)', borderRadius: '14px', padding: '26px', background: 'var(--janus-surface)', display: 'flex', flexDirection: 'column', gap: '10px' }}>
        ...
        <p style={{ margin: '22px 0 0', textAlign: 'center', font: '400 13.5px/1.6 "DM Sans", sans-serif', color: 'var(--janus-text-muted)' }}>Nothing below depends on anything above it — you can use the core on its own, headless.</p>
      </section>

      {/* ── CTA ─────────────────────────── */}
      <section style={{ padding: '112px 40px 0' }}>
        <div style={{ border: '1.5px solid var(--janus-border)', borderRadius: '14px', background: 'var(--janus-surface)', padding: '64px 48px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '22px', textAlign: 'center', boxShadow: 'var(--janus-shadow)' }}>
          <h2 style={{ margin: '0', font: '700 40px/1.1 "DM Sans", sans-serif', letterSpacing: '-0.028em', maxWidth: '24ch', color: 'var(--janus-text)' }}>Add a scheduler this afternoon</h2>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginTop: '6px', padding: '12px 14px', border: '1.5px solid var(--janus-border)', borderRadius: '9px', background: 'var(--janus-bg)' }}>
            <span style={{ font: '400 13.5px/1 "JetBrains Mono", monospace', color: 'var(--janus-accent)' }}>$</span>
            <span style={{ font: '400 13.5px/1 "JetBrains Mono", monospace', color: 'var(--janus-text)' }}>npm i @janus-scheduler/react</span>
            <button onClick={handleCopyCta} style={{ height: '26px', padding: '0 9px', border: '1.5px solid var(--janus-border)', borderRadius: '9px', background: 'var(--janus-surface)', color: 'var(--janus-text-secondary)', font: '500 11px/1 "JetBrains Mono", monospace', cursor: 'pointer' }}>{copiedCta ? 'Copied' : 'Copy'}</button>
          </div>
          <Link 
